...
## read files
data_act_ori = \
np.genfromtxt(file_path+'endeff_ori_act.txt', delimiter=None, dtype=(float))
data_des_ori = \
np.genfromtxt(file_path+'endeff_ori_des.txt', delimiter=None, dtype=(float))

data_ori_err = \
np.genfromtxt(file_path+'ori_error_vec.txt', delimiter=None, dtype=(float))

# # data_x = np.genfromtxt(file_path+'time.txt', delimiter='\n', dtype=(float))
data_x = np.arange(data_ori_err.shape[0]) 
